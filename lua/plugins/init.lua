...
map("n", "<leader>fF", function() Snacks.picker.files({ hidden = true, ignored = true, exclude = { "node_modules" } }) end, { desc = "Find All Files (Ignored)" })
...
map("n", "<leader>fW", function() Snacks.picker.grep({ hidden = true, ignored = true, exclude = { "node_modules" } }) end, { desc = "Live Grep (Ignored)" })
